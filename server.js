...
mongoose.connect(DB_URI, { useNewUrlParser: true, useUnifiedTopology: true })
    .then(db => console.log("Conexión a BD de meteoBackend correcta"))
    .catch(error => console.log("Error al conectarse a la BD de metoBackend" + error));
...
// SERVIDOR WEB
app.listen(PORT, () => console.log("Servidor iniciado para meteoBackend..."));
